...
namespace APIVerve
{
    public class VINDecoderAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/vindecoder";
        ...
        public VINDecoderAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public VINDecoderAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, vindecoderQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(vindecoderQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(vindecoderQueryOptions options)
        {
